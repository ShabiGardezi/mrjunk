        ...
        <div className="custom-container flex justify-center">
          <div className="lm:grid xl:grid-cols-4 lm:grid-cols-12 xl:gap-x-[30px] gap-[30px]">
                ...
                <div className="text-gray-500">
                  <div className="mb-2 mt-4">
                    ...
                    <Link href="mailto:dan@mrjunkaway.com">
                      <span className="hover:text-black transition-all mb-2">
                        dan@mrjunkaway.com
                      </span>
                    </Link>
                  </div>
                  ...
                  <div>
                    ...
                    <br />
                    <Link href="https://www.yelp.com/biz/mr-junkaway-spokane-3">
                      <span className="hover:text-black transition-all mb-2">
                        Yelp
                      </span>
                    </Link>
            ...
            <div className="fixed-lg:col-span-2 fixed-md:col-span-2 fixed-lm:col-span-6 max-sm:pt-[30px]">
              <div className="footer-widget-item">
                <h2 className="title">Mr. Junkaway</h2>
            ...
            <div className="md:grid md:grid-cols-3 flex flex-col">
              ...
              <div className="md:col-span-1">
                <ul className="footer-social-link md:mb-0 mb-[10px] flex justify-center">
                  <li>
                    <Link href="https://facebook.com/mrjunkaway">
                      <span>Facebook</span>
                    </Link>
                  </li>
                </ul>
              ...
              <div className="md:col-span-1">
                <ul className="footer-language flex md:justify-end justify-center">
                  <li className="mr-8">
                    <Link href="#">
                      <span className="text-[#30373E] text-[14px] leading-6 uppercase transition-all hover:text-[#263a4f]">
                        Eng
                      </span>
                    </Link>
                  </li>
